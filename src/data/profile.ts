...
export const contentPlan = [
  {
    ...
    needed: "1 strong cinematic portrait, 1 neutral headshot, 1 waist-up portrait and 1 full-body photo.",
    suggestedFiles: "public/images/portraits/taisija-hero.webp, taisija-headshot.webp, taisija-full-body.webp"
  },
  {
    title: "Acting showreel",
    ...
    suggestedFiles: "Use a Vimeo/YouTube link or add public/video/taisija-showreel-2026.mp4"
  },
  {
    title: "Voice samples",
    ...
    suggestedFiles: "public/audio/taisija-voice-commercial-en.mp3, taisija-voice-character-it.mp3"
  },
  {
    title: "Music samples",
    where: "Music block",
    needed: "One vocal fragment and one piano fragment, 30-90 seconds each, with clean sound.",
    suggestedFiles: "public/audio/taisija-vocal-live.mp3, public/video/taisija-piano-2026.mp4"
  },
  {
    title: "Hosting reel",
    where: "Hosting / live events block",
    needed: "Fragments from events showing speech, audience contact, confidence and multilingual delivery.",
    suggestedFiles: "public/video/taisija-hosting-reel-2026.mp4"
  },
  {
    title: "Aerial gymnastics material",
    where: "Special skills and casting profile",
    needed: "Short video or 2-3 stills showing movement quality, line, control and camera-safe physical skill.",
    suggestedFiles: "public/images/special-skills/taisija-aerial-01.webp"
  },
  {
    title: "Official CV and credits",
    where: "Casting profile and download buttons",
    needed: "Exact theatre, film, series, commercial and dubbing credits with years, roles and productions.",
    suggestedFiles: "public/downloads/taisija-boyko-cv-en-2026.pdf"
  },
  {
    title: "Press kit",
    where: "Future press / booking block",
    needed: "Short bio, medium bio, 2-3 approved photos, CV and official contact details.",
    suggestedFiles: "public/downloads/taisija-boyko-press-kit-2026.zip"
  }
] as const;
