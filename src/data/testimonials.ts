...
export const testimonialFeatures: Partial<Record<Locale, TestimonialFeature>> = {
  uk: {
    ...
    approvalNote:
      "Це редакційна чернетка. Перед публічним використанням її потрібно погодити з Ольгою Сморкіс або замінити на її точні слова.",
    nextLabel: "Що додати далі",
    nextItems: [
      "Підтверджену цитату Ольги або короткий аудіовідгук українською.",
      "Назву концерту, дату, місто й афішу або програму події."
    ]
  }
};
